...
return [
    ...
    */
    ...
    // Credentials live in the admin panel (Crypto Payment page). Only the URL
    // override is env-driven, so a mock server can be used for local testing.
    'nowpayments' => [
        'url' => env('NOWPAYMENTS_API_URL', ''),
    ],
