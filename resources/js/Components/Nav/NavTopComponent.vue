                ...
                <div class="flex items-center justify-start py-3">
                    ...
                    <a v-if="setting" href="/" class="flex ml-2 md:mr-24">
                        ...
                        <div class="block sm:hidden">
                            <img v-if="setting.software_favicon" :src="`/storage/`+setting.software_favicon" class="h-10 mr-3" alt="" />
                            <img v-else :src="`/storage/`+setting.software_logo_white" class="h-10 mr-3" alt="" />
                        </div>
                    </a>
                </div>
                    ...
                    <div class="mb-5 w-full">
                        <div class="md:w-4/6 2xl:w-4/6 mx-auto">
                            <div class="flex flex-col">
                                <div class="relative w-full">
                                    <input type="search"
                                           ...
                                           :placeholder="$t('Game name | Provider')"
                                           required>
                                ...
                                <div class="text-center mt-4">
                                    <p>{{ $t('Search requires at least 3 characters') }}</p>
                                </div>
                            </div>
                            ...
                            <div v-else class="relative items-center block max-w-sm p-6 bg-white border border-gray-100 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-800 dark:hover:bg-gray-700">
                                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white opacity-20">{{ $t('Search games') }}</h5>
                                <p class="font-normal text-gray-700 dark:text-gray-400 opacity-20">{{ $t('Type the name of a game or provider') }}</p>
            ...
            <div class="flex md:justify-between">
                ...
                <div class="w-full relative p-5">
                    ...
                    <form @submit.prevent="loginSubmit" method="post" action="" class="">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-300 mb-6">{{ $t('New here?') }} <a href="" @click.prevent="hideLoginShowRegisterToggle"><strong>{{ $t('Create account') }}</strong></a></p>
                    </form>
            ...
            <div v-if="!isLoadingProfile" class="flex flex-col">
                ...
                <div v-if="profileUser != null" class="flex flex-col w-full p-4">
                    ...
                    <div class="py-3 text-center">
                        <p>{{ $t('Joined') }} {{ profileUser.dateHumanReadable }}</p>
                    </div>
