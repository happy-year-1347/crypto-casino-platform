    ...
    <BaseLayout>
        ...
        <div v-if="!isLoading" class="">
            ...
            <div class="md:w-4/6 2xl:w-4/6 mx-auto p-4">
                    ...
                    <div class="flex">
                        <div class="relative w-full">
                            <input @click.prevent="toggleSearch" type="search"
                                   ...
                                   :placeholder="$t('Game name')" required>
                ...
                <div v-if="isAuthenticated" class="flex items-center justify-center mb-4">
                    <div class="grid py-4">
                        <h1 class="text-lg font-bold mb-3 text-center">{{ $t('PREFERRED PAYMENT METHOD') }}</h1>
                        <div class="payment-list flex items-center justify-center gap-4 text-3xl">
                            <i class="fa-brands fa-bitcoin text-orange-500" title="Bitcoin"></i>
                            <i class="fa-brands fa-ethereum text-gray-400" title="Ethereum"></i>
                            <span class="text-sm font-semibold">BTC / LTC / USDT / TRX / DOGE</span>
                        </div>
                    </div>
                </div>
            </div>
