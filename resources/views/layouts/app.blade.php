...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    <head>
        ...
        {{-- env() returns nothing once the config is cached, which left the tab blank --}}
        <title>{{ $setting['software_name'] ?? config('app.name') }}</title>
        @if(!empty($setting['software_description']))
            <meta name="description" content="{{ $setting['software_description'] }}">
            <meta property="og:title" content="{{ $setting['software_name'] ?? config('app.name') }}">
            <meta property="og:description" content="{{ $setting['software_description'] }}">
