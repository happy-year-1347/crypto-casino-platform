...
class IndicationsTableWidget extends BaseWidget
{
    ...
    protected static ?string $heading = 'All Referrals';
        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('losses')
                    ->formatStateUsing(fn (AffiliateHistory $record): string => 'Qty: '.$record->losses.' - Total: '.(\Helper::getSetting()->prefix ?? '$').$record->losses_amount)
                    ->label('Losses')
                    ->searchable(),
